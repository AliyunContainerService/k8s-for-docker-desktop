...
* The master branch is tested with Docker Desktop for Mac/Windows version 2.4.2.0 Edge (with Docker CE 20.10.0 and Kubernetes 1.9.2). 
* If you want to use with other version, pls check version of Kubernetes，Docker -> About Docker Desktop
    ![about](images/about.png)
    * For Kubernetes v1.18.8, please use the v1.18.6 branch ```git checkout v1.18.8```
